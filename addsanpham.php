                    ...
                    <form action="submitaddsanpham.php" method='POST' enctype="multipart/form-data">
                        ...
                        <div class="">				
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Khối lượng"  name='khoiluong' required>
                            </div>	
                            <div class="form-group">
                                <label>Ngày sản xuất</label>
                                <input type="date" class="form-control"   name='ngaysx' required>
                            </div>
                            <div class="form-group">
                                <label>Hạn sử dụng</label>
                                <input type="text" class="form-control"   name='hansd' required>
                            </div>
                            <div class="form-group">
                                <label>Đối tượng sử dụng</label>
                                <input type="text" class="form-control" placeholder="Đối tượng sử dụng"   name='doituongsd' required>
                            </div>	
                            <div class="form-group">
