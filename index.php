<?php
   ...
   $sql ="SELECT * FROM SANPHAM where id_dm=1 limit 5";
   $sql2 ="SELECT * FROM SANPHAM where id_dm=2 limit 5";
...
<body>
			...
			<div class="main-menu-search"> 
				<div class="container-main">
					...
					<div class="left-main" id="hide-scroll2">
						<p class="logo-shop">
							<a href="#" title="Logo"><img src="images/logo198.png" alt="Logo"/></a>
						</p>
					</div>
	...
	<div class="content-main">
		<div class="container-pr">
			<h3 class="h3"><a href="#" title="Tăng Cân">Tăng Cân</a></h3>
			<div class="row">
		...
		<div class="container-pr">
			<h3 class="h3"><a href="#" title="Tăng Cơ">Tăng Cơ</a></h3>
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<div class="product-grid6">
						...
						<div class="product-content">
							...
							<div class="price"><?php echo $values2["giakm"]; ?>
								<span><?php echo $values2["giact"]; ?></span>
							</div>
						</div>
						<ul class="social">
		...
		<div class="container-pr">
			<h3 class="h3"><a href="#" title="Tăng sức mạnh và sức bền">Tăng sức mạnh và sức bền</a></h3>
			<div class="row">			
				<div class="col-md-3 col-sm-6">
					<div class="product-grid6">
						<div class="product-image6">
							<a href="#">
								<img class="pic-1" src="images/r1-bcaa.jpg">
							</a>
						</div>
						<div class="product-content">
							<h3 class="title"><a href="#">Sữa Tăng Sức Bền Rule One Proteins R1 BCAA 30 lần dùng - 5 mùi </a></h3>
							<div class="price">545,000 ₫
								<span>560,000 ₫</span>
							</div>
						</div>
						<ul class="social">
							<li><a href="" data-tip="Xem nhanh"><i class="fa fa-search"></i></a></li>
							<li><a href="" data-tip="Xem chi tiết"><i class="fas fa-eye"></i></a></li>
				...
				<div class="col-md-3 col-sm-6">
					<div class="product-grid6">
						<div class="product-image6">
							<a href="#">
								<img class="pic-1" src="images/true-bcaa-peach.jpg">
							</a>
						</div>
						<div class="product-content">
							<h3 class="title"><a href="#">Sữa Phục Hồi Chống Đau Mỏi Cơ Elite Labs USA True BCAA 195g</a></h3>
							<div class="price">540,000 ₫
								<span>590,000 ₫</span>
							</div>
						</div>
						<ul class="social">
				...
				<div class="col-md-3 col-sm-6">
					<div class="product-grid6">
						<div class="product-image6">
							<a href="#">
								<img class="pic-1" src="images/bpi-best-bcaa.jpg">
							</a>
						</div>
						<div class="product-content">
							<h3 class="title"><a href="#">BPI Sports Best BCAA 600g - Phục hồi chống đau mỏi cơ 60 servings</a></h3>
							<div class="price">540,000 ₫
								<span>600,000 ₫</span>
							</div>
						</div>
				...
				<div class="col-md-3 col-sm-6">
					<div class="product-grid6">
						<div class="product-image6">
							<a href="#">
								<img class="pic-1" src="images/gold_standard.jpg">
							</a>
						</div>
						<div class="product-content">
							<h3 class="title"><a href="#">Sữa Tăng Sức Mạnh ON Gold Standard Pre-Workout 300g</a></h3>
							<div class="price">435,000 ₫
								<span>600,000 ₫</span>
							</div>
						</div>
						<ul class="social">
				...
				<div class="col-md-3 col-sm-6">
					<div class="product-grid6">
						<div class="product-image6">
							<a href="#">
								<img class="pic-1" src="images/blade-eaa-collagen.jpg">
							</a>
						</div>
						<div class="product-content">
							<h3 class="title"><a href="#">Sữa Phục Hồi Phát Triển Cơ Bắp Blade EAA + Collagen</a></h3>
							<div class="price">420,000 ₫
								<span>480,000 ₫</span>
							</div>
						</div>
						<ul class="social">
