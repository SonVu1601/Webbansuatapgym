    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="adminmanage.php">Admin Web bán sữa tập gym</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <form action="submitsuasp.php?id=<?php echo $values['id']?>" method='POST' enctype="multipart/form-data">
                        ...
                        <div class="">				
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Khối lượng"  value="<?php echo $values['khoiluong'] ?>"  name='khoiluong' required>
                            </div>	
                            <div class="form-group">
                                <label>Ngày sản xuất</label>
                                <input type="date" class="form-control"   name='ngaysx'  value="<?php echo $values['ngaysx'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Hạn sử dụng</label>
                                <input type="text" class="form-control"   name='hansd'  value="<?php echo $values['hansd'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Đối tượng sử dụng</label>
                                <input type="text" class="form-control" placeholder="Đối tượng sử dụng"  value="<?php echo $values['doituongsd'] ?>"  name='doituongsd' required>
                            </div>	
                            <div class="form-group">
