<?php
    ...
    if(isset($_POST["them"])){
        ...
        if( mysqli_num_rows($old) > 0){
            ...
            $sql = "INSERT INTO  sanpham(id_dm,tensp,khoiluong,ngaysx,hansd,giact,giakm,thuonghieu,anhsp,doituongsd,motasp)
            VALUES('$id_dm','$tensp','$khoiluong','$ngaysx','$hansd','$giact','$giakm','$thuonghieu','$image','$doituongsd','$mota')";
            $target_dir = "images/";
