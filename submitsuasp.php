<?php
    ...
    if(isset($_POST["them"])){
        ...
        $uploadOk = 1;
        $sql = "UPDATE sanpham SET id_dm='$id_dm',tensp='$tensp',khoiluong='$khoiluong',hansd='$ngaysx',hansd='$hansd',giact='$giact',giakm='$giakm',thuonghieu='$thuonghieu',anhsp='$image',doituongsd='$doituongsd',motasp='$mota' WHERE id =$id";
        $target_dir = "images/";
