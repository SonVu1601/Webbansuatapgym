<?php
    ...
    $sql1 ="SELECT tenloai FROM danhmuc WHERE id = $id";
                        ...
                        <div class="container-inf-dtpr">
                            ...
                            <div class="single-infoagile">
                                ...
                                ?>
                                    ...
                                    <li class="inf-dtproduct">
                                        <i class="fas fa-check-circle"></i>Khối lượng tịnh: <?php echo $values["khoiluong"]; ?>
                                    </li>
                                    <li class="inf-dtproduct">
                                        <i class="fas fa-check-circle"></i>Thương hiệu: <?php echo $values["thuonghieu"]; ?>
                                    </li>
                                    <li class="inf-dtproduct">
                                        <i class="fas fa-check-circle"></i>Ngày sản xuất: <?php echo $values["ngaysx"]; ?>
                                    </li>
                                    <li class="inf-dtproduct">
                                        <i class="fas fa-check-circle"></i>Hạn sử dụng: <?php echo $values["hansd"]; ?>
                                    </li>
                                    <li class="inf-dtproduct">
                                        <i class="fas fa-check-circle"></i>Đối tượng: <?php echo $values["doituongsd"]; ?>
                                    </li>
                                </ul>
                            </div>
